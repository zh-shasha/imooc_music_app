...
public class AdBrowserWebViewClient extends WebViewClient {
    ...
    private Listener mEmptyListener = new Listener() {
        ...
        @Override public void onPageFinished(boolean canGoBack) {
        }

        @Override public void onReceiveError() {
        }

        @Override public void onLeaveApp() {
        }
    };
    ...
    @Override public final void onPageStarted(WebView view, String url, Bitmap favicon) {
        super.onPageStarted(view, url, favicon);
        mListener.onPageStarted();
    }

    @Override public final void onPageFinished(WebView view, String url) {
