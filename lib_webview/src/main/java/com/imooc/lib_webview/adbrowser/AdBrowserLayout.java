package com.imooc.lib_webview.adbrowser;
...
public final class AdBrowserLayout extends RelativeLayout {
    ...
    public AdBrowserLayout(Context context) {
        ...
        LayoutParams buttons_params =
                new LayoutParams(buttonWidth, ViewGroup.LayoutParams.MATCH_PARENT);
    ...
    private void configProgressButton(Context context, LinearLayout buttonsContainer,
    ...
    private void configButtonsContainer(LinearLayout buttonsContainer) {
        LinearLayout.LayoutParams buttonsContainerParams =
    ...
    private void configFooterView() {
        LayoutParams footer_params =
                new LayoutParams(LayoutParams.MATCH_PARENT, Utils.dip2px(getContext(), HEADER_HEIGHT_DP));
    ...
    private View initBottomWhiteLineView(Context context) {
        ...
        LayoutParams whiteLineParams = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, 1);
